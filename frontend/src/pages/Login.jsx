      ...
      <div className="hidden lg:flex flex-col justify-between w-[420px] shrink-0 bg-indigo-600 dark:bg-[#0b1120] border-r border-indigo-500 dark:border-slate-800/80 px-10 py-12">
        ...
        <div>
          <h2 className="text-3xl font-bold text-white leading-snug mb-3">
            Gerencie seus cursos com facilidade
          </h2>
          <p className="text-indigo-200 dark:text-slate-400 text-sm leading-relaxed">
            Crie, organize e publique aulas com vídeos, materiais em Markdown e links úteis.
          </p>

          <div className="mt-8 space-y-3">
            {['Gestão completa de cursos e aulas', 'Material em Markdown com syntax highlight', 'Vídeos do YouTube integrados'].map((f) => (
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 relative">
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="mb-7">
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Entre na sua conta para continuar</p>
          </div>
